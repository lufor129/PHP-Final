...
<body>
        <nav class="user-nav">
            ...
            <div class="list-group">
                ...
                <a href="#" class="list-group-item"><i class="fa fa-bitcoin"></i>  儲值</a>
                <a href="#" class="list-group-item"><i class="fa fa-gift"></i>  已購買漫畫</a>
                <a href="#" class="list-group-item"><i class="fa fa-upload"></i>  上傳漫畫</a>
                <a href="#" class="list-group-item"><i class="fa fa-cog"></i>  修改上傳漫畫</a>
                <a href="#" class="list-group-item"><i class="fa fa-cogs"></i>  修改會員資料</a>
                <a href="#" class="list-group-item"><i class="fa fa-line-chart"></i>  數據分析</a>
